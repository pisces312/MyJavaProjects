 ...
 * 
 *         Using the KJDigitalSignalProcessor package, this component can
 *         display a realtime
...
public class KJScopeAndSpectrumAnalyser extends Component implements KJDigitalSignalProcessor {
     ...
     * 
     */
    private static final long serialVersionUID                          = -6538832180764460600L;
    ...
    private void drawScope(Graphics pGrp, float [] pSample) {
        ...
        int wSt = 2;
        //TODO
        for (int a = wSt, c = 0; c < width && a < pSample.length; a += wSt, c++) {
    ...
    /**
     * When 'true' is passed as a parameter, will overlay the
     * "Frames Per Seconds"
