...
public abstract class Instrument extends Thread implements Runnable, jm.JMC {
    ...
    protected Vector<AudioObject>                 primaryAO;
    ...
    protected volatile Vector<AudioChainListener> listeners        = new Vector<AudioChainListener>();
    ...
    /**
     * Output from instrument should go to RTLine and RTMixer for realtime
     * playback.
     * This normally means the SampleOut audio object is NOT part of the audio
     * chain.
     */
    public final static int                       REALTIME         = 1;
    /**
     * Which output type is the instrument for? Rendering, realtime, or other.
     * This flag must be handled by each instrument, as it is not static
     * (global).
     */
    ...
    protected Instrument() {
        primaryAO = new Vector<AudioObject>();
    }
    ...
    public void renderNote(Note note, double startTime) {
        this.finalAO = null;
        Enumeration<AudioObject> enum1 = primaryAO.elements();
     ...
     * 
     * @return numOfChannels The number of channels being used by this
     *         instrument
     */
     ...
     */
    public Enumeration<AudioChainListener> getListeners() {
    ...
    */
     ...
     * However, these flags must be handled by each instrument, as they are not
     * global.
     */
    ...
    //----------------------------------------------
    /**
     * The iterate chain method is responsible for pulling the appropriate
    ...
    public void iterateChain() {
        ...
        while (!finished) {
            ...
            for (i = 0; i < returned; i++) {
                ...
                if (index == bufsize) {
                    index = 0;
                    Enumeration<AudioChainListener> enum1 = listeners.elements();
                    while (enum1.hasMoreElements()) {
