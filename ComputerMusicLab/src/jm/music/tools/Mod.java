...
public class Mod implements JMC {
     ...
     * 
     * <P>
     * The second note remains unchanged. If either <CODE>note1</CODE> or
     ...
     * 
     * <P>
     * If <CODE>note</CODE> is null then this method does nothing. If the
     ...
     * transposed 1 will become D, transposed 4 will become G, and transposed by
     * 7 will beome C an octave above. This can be somewhat unintuitive so be
     * careful.
     * 
     ...
     * 
     * <P>
     * If <CODE>phrase</CODE> is null then this method does nothing. If the
     * transposition shifts a pitch above {@link Note#MAX_PITCH MAX_PITCH} or
     * below {@link Note#MIN_PITCH MIN_PITCH}, the pitch will probably cap at
     * those values. See the description of {@link Note#setPitch} method for
     * exact details of what occurs when trying to set the pitch beyond the
     ...
     * 
     * <P>
     * If <CODE>phrase</CODE> is null then this method does nothing.
     * 
     ...
     * 
     * <P>
     * If <CODE>phrase</CODE> is null or <CODE>n</CODE> is less than on then
     ...
     * 
     * <P>
     * If <CODE>phrase</CODE> is null; or <CODE>startLoc</CODE> is greater than
     * or equal to <CODE>endLoc</CODE> then this method does nothing.
     * 
     ...
     * 
     * <P>
     * If <CODE>phrase</CODE> is null; <CODE>startLoc</CODE> is greater than or
     * equal to <CODE>endLoc</CODE>; or <CODE>n</CODE> is less than one then
     * this method does nothing.
     * 
     * @param phrase Phrase with section to be repeated
     ...
     * 
     * <P>
     * If <CODE>phrase</CODE> is null; or if <CODE>fadeLength</CODE> is less
     * than or equal to zero then this method does nothing.
     * 
     * @param phrase Phrase to be faded
     * @param fadelength double describing the number of beats (crotchets) to
     *            fade
     *            over
     */
     ...
     * 
     * <P>
     * If <CODE>phrase</CODE> is null; <CODE>fadeLength</CODE> is less than or
     ...
     * <P>
     * If <CODE>phrase</CODE> is null; <CODE>fadeLength</CODE> is less than or
     * equal to zero; <CODE>phraseEndTime</CODE> is less than zero; or <CODE>
     ...
     * 
     * <P>
     * This compression applies only to the volume, technically the dynamic, of
     * the notes. It will multiply the difference between each of the notes'
     ...
     * 
     * <P>
     * If either <CODE>phrase1</CODE> or <CODE>phrase2</CODE> is null then this
     * method does nothing.
     * 
     ...
     * quantised to exactly a quaver. Together the three notes now extend over a
     * dotted crotchet, whereas previously they occupied only a crotchet. If
     ...
     * 
     * <P>
     * If <CODE>phrase</CODE> is null or <CODE>qValue</CODE> is less than or
     ...
     * 
     * <P>
     * The repetitions work in the same manner as {@link #repeat}, except that
     * the final repetition will not be a complete copy of the original phrase
     * if the note count is reached before the repetition is completed.
     * 
     * <P>
     * If <CODE>phrase</CODE> is null or if <CODE>numNotes</CODE> is less than
     * or equal to the number of notes in the phrase then this method does
     * nothing.
     * 
     ...
     * The repetitions work in the same manner as {@link #repeat}, except that
     * the final repetition will not be a complete copy of the original phrase
     * if the rhythm value count is reached before the repetition is completed.
     * 
     * <P>
     ...
     * 
     * <P>
     * If <CODE>phrase</CODE> is null this method does nothing.
     * 
     ...
     * 
     * <P>
     * If <CODE>phrase</CODE> is null or <CODE>newLength</CODE> is less than or
     * equal to zero then this method does nothing.
     * 
     ...
     * 
     * <P>
     * If <CODE>phrase</CODE> is null or <CODE>scaleFactor</CODE> is less than
     ...
     * 
     * <P>
     * The dynamic of each note starting on the beat will be increased by 20. If
     * this raises the dynamic above {@link Note#MAX_DYNAMIC MAX_DYNAMIC * }
     * then the dynamic will be set to a value as described in
     * {@link Note#setDynamic}.
     * 
     * <P>
     * If <CODE>phrase</CODE> is null or <CODE>meter</CODE> is less than or
     * equal to zero then this method does nothing.
     * 
     ...
     * 
     * <P>
     * <CODE>accentedBeats</CODE> is an array of values describing where the
     * accents begin relative to the start of each bar, in crochets.
     * 
     * <P>
     * Each accented note's dynamic will be increased by 20. If this raises the
     * dynamic above {@link Note#MAX_DYNAMIC MAX_DYNAMIC} then the dynamic will
     * be set to a value as described in {@link Note#setDynamic}.
     * 
     * <P>
     * Each of the double values in <CODE>accentedBeats</CODE> must be greater
     * than or equal to zero and less than <CODE>meter</CODE> or this method
     * does nothing.
     * 
     * <P>
     * If <CODE>phrase</CODE> is null or <CODE>meter</CODE> is less than or
     ...
     * 
     * <P>
     * Accented beats will have their dynamic increased by <CODE>
     * accentAmount</CODE>. If this causes the dynamic to be above
     * {@link Note#MAX_DYNAMIC MAX_DYNAMIC} or below {@link Note#MIN_DYNAMIC
     ...
     * 
     * @param phrase The Phrase to be effected
     * @param int The amount of effect - e.g., 5 will be +-5 from the current
     *        amount
     */
     ...
     * @param double rhythmCount The number of notes to have thier rhythm
     *        altered
     * @param int[] pitches The scale values from which to select for
     *        relacements
     ...
     * @param double[] rhythms The rhyythm values from which to select
     *        replacements
     */
    ...
    /**
     * Joins consecutive rests in the <CODE>phrase</CODE> creating one longer
     * note.
     * This is simmilar to the musical function of a tie.
    ...
    /**
     * Lengthens notes followed by a rest in the <CODE>phrase</CODE> by creating
     * one longer note and deleting the rest.
    ...
    /**
     * Randomly adjusts all Notes' pan value to create an even spread acroos the
     * stereo spectrum.
    ...
    /**
     * Adjusts all Note pan values to alternate between extreme left and right
     * from note to note.
     * This process only effects the pan value of the notes in the phrase.
     * <P>
     * If <CODE>phrase</CODE> is null then this method does nothing.
    ...
    /**
     * Adjusts all Note duration values to vary randomly between specified
     * values from note to note.
     * This process only effects the duration attribute of the notes in the
     * phrase.
     * <P>
     * If <CODE>phrase</CODE> is null then this method does nothing.
     * 
    ...
    /**
     * Vary both the rhythm value and duration of each note in the phrase by the
     * specified amount.
     * 
     * @param phrase The phrase to be modified.
     * @param double The amount to add.
    ...
    /**
     * Vary the interval between notes scaling by the specified amount to each
     * interval.
     * 
     * @param phrase - The phrase to be modified.
     * @param amount - The scaling multiplyer for the intervals, i.e., 2.0
     *            doubles width.
     */
     ...
     * 
     * <P>
     * If <CODE>cphrase</CODE> is null then this method does nothing. If the
     * pitch is transposed to a value greater than {@link Note#MAX_PITCH
     ...
     * 
     * <P>
     * If <CODE>cphrase</CODE> is null this method does nothing.
     * 
     ...
     * 
     * <P>
     * If <CODE>cphrase</CODE> is null or <CODE>times</CODE> is less than one
     * this mthod does nothing.
     * 
     * @param cphrase CPhrase to be repeated
     ...
     * 
     * <P>
     * If <CODE>cphrase</CODE> is null; or <CODE>startLoc</CODE> is greater than
     * or equal to <CODE>endLoc</CODE> then this method does nothing.
     * 
     * @param cphrase CPhrase to be repeated
     ...
     * 
     * <P>
     * If <CODE>cphrase</CODE> is null; <CODE>startLoc</CODE> is greater than or
     * equal to <CODE>endLoc</CODE>; or <CODE>n</CODE> is less than one then
     * this method does nothing.
     * 
     * @param cphrase CPhrase to be repeated
     ...
     * 
     * <P>
     * If <CODE>cphrase</CODE> is null; or if <CODE>fadeLength</CODE> is less
     * than or equal to zero then this method does nothing.
     * 
     ...
     * 
     * <P>
     * If <CODE>cphrase</CODE> is null; <CODE>fadeLength</CODE> is less than or
     * equal to zero; <CODE>cphraseStartTime</CODE> is less than zero; or
     ...
     * <P>
     * If <CODE>cphrase</CODE> is null; <CODE>fadeLength</CODE> is less than or
     * equal to zero; <CODE>cphraseEndTime</CODE> is less than zero; or
     ...
     * 
     * <P>
     * If <CODE>cphrase</CODE> is null then this method does nothing.
     * 
     ...
     * 
     * <P>
     * If <CODE>cphrase1</CODE> or <CODE>cphrase2</CODE> is null then this
     * method does nothing.
     * 
     ...
     * 
     * <P>
     * If <CODE>cphrase</CODE> is null or <CODE>qValue</CODE> is less than or
     * equal to zero then this method does nothing.
     * 
     ...
     * 
     * <P>
     * If <CODE>cphrase</CODE> is null or <CODE>scaleFactor</CODE> is less than
     * or equal to zero then this method does nothing.
     * 
     ...
     * 
     * <P>
     * If <CODE>cphrase</CODE> is null or <CODE>meter</CODE> is less than or
     * equal to zero then this method does nothing.
     * 
    ...
    /**
     * Adjusts all Notes' pan value to alternate between extreme left and right
     * from note to note.
     * This process only effects the pan value of the notes in the cphrase.
     * <P>
     * If <CODE>cphrase</CODE> is null then this method does nothing.
    ...
    /**
     * Joins consecutive rests in each <CODE>CPhrase</CODE> creating one longer
     * note.
     * This is simmilar to the musical function of a tie.
     * This modification may reduce the overall rest count.
     * 
    ...
    /**
     * Lengthens notes followed by a rest in the <CODE>CPhrase</CODE> by
    ...
    /**
     * Adjusts all Notes' duration values to vary randomly between specified
     * values from note to note.
     * This process only effects the duration attribute of the notes in the
     * phrase.
     * <P>
    ...
    /**
     * Vary the rhythm value of each note in the cphrase by the specified
     * amount.
     * 
    ...
    /**
     * Randomise the dynamic values of notes up to a specified amount either
     * side of the current value.
     * 
     * @param cphrase - The CPhrase to be modified.
     * @param amount - The dynamic change possible either side of the curent
     *            dynamic.
     */
     ...
     * <P>
     * If <CODE>part</CODE> is null this method does nothing.
     * 
     ...
     * 
     * <P>
     * If <CODE>part</CODE> is null or <CODE>times</CODE> is less than one this
     * method does nothing.
     * 
     ...
     * 
     * <P>
     * If <CODE>part</CODE> is null; or <CODE>startLoc</CODE> is greater than or
     * equal to <CODE>endLoc</CODE> then this method does nothing.
     * 
     * @param part Part to be repeated
     * @param startLoc location of the loop start in beats
     * @param endLoc location of the loop end in beats
     ...
     * 
     * <P>
     * If <CODE>part</CODE> is null; <CODE>startLoc</CODE> is greater than or
     * equal to <CODE>endLoc</CODE>; or <CODE>n</CODE> is less than one then
     * this method does nothing.
     * 
     * @param part Part to be repeated
     ...
     * 
     * <P>
     * If <CODE>part</CODE> is null then this method does nothing. If the
     * transposition shifts a pitch above {@link Note#MAX_PITCH MAX_PITCH} or
     * below {@link Note#MIN_PITCH MIN_PITCH}, the pitch will probably cap at
     * those values. See the description of {@link Note#setPitch} method for
     * exact details of what occurs when trying to set the pitch beyond the
     ...
     * 
     * <P>
     * This is a basic compression routine and is not perfect. Specifically,
     * each phrase compresses relative to itself, not to the overall part as
     * might be expected.
     * 
     * <P>
     * If <CODE>part</CODE> is null then this method does nothing.
     * 
     ...
     * 
     * <P>
     * If <CODE>part1</CODE> or <CODE>part2</CODE> is null then this method does
     * nothing.
     * 
     ...
     * 
     * <P>
     * If <CODE>part1</CODE> or <CODE>part2</CODE> is null
     * 
     * @param part1 the base Part
     * @param part2 the Part to be appended
     ...
     * 
     * <P>
     * If <CODE>part</CODE> is null; or if <CODE>fadeLength</CODE> is less than
     * or equal to zero then this method does nothing.
     * 
     ...
     * 
     * <P>
     * If <CODE>part</CODE> is null; <CODE>fadeLength</CODE> is less than or
     * equal to zero; <CODE>phraseStart</CODE> is less than zero; or <CODE>
     * fadeLength</CODE> is less than or equal to <CODE>phraseStart</CODE> then
     * this method does nothing.
     * 
     ...
     * 
     * <P>
     * If <CODE>part1</CODE> or <CODE>part2</CODE> is null this method does
     * nothing.
     * 
     * @param part1 the base Part
     ...
     * 
     * <P>
     * If <CODE>part</CODE> is null or <CODE>qValue</CODE> is less than or equal
     * to zero then this method does nothing.
     * 
     ...
     * 
     * <P>
     * If <CODE>part</CODE> is null or <CODE>meter</CODE> is less than or equal
     * to zero then this method does nothing.
     * 
    ...
    /**
     * Stretch the time of each note in each phrase by the
    ...
    /**
     * Joins consecutive rests in each <CODE>part</CODE> creating one longer
     * note.
     * This is simmilar to the musical function of a tie.
     * This modification may reduce the overall rest count.
     * 
    ...
    /**
     * Lengthens notes followed by a rest in the <CODE>part</CODE> by creating
     * one longer note and deleting the rest.
     * This modification may reduce the overall note count in the phrase,
     * be careful that use of this method does not to cause
     * array out of bounds exceptions.
    ...
    /**
     * Vary both the rhythm value and duration of each note in the part by the
     * specified amount.
     * 
     * @param part - The Part to be modified.
     * @param amount - The number of beats to add.
     ...
     * 
     * <P>
     * If <CODE>score</CODE> is null then this method does nothing. If the
     * transposition shifts a pitch above {@link Note#MAX_PITCH MAX_PITCH} or
     * below {@link Note#MIN_PITCH MIN_PITCH}, the pitch will probably cap at
     * those values. See the description of {@link Note#setPitch} method for
     * exact details of what occurs when trying to set the pitch beyond the
     ...
     * 
     * <P>
     * If <CODE>score</CODE> is null or <CODE>fadeLength</CODE> is less than or
     * equal to zero then this method does nothing.
     * 
     * @param score Score to be faded
     * @param fadelength double describing the number of crotchets to fade
     ...
     * 
     * <P>
     * If <CODE>score</CODE> is null then this method does nothing.
     * 
     ...
     * 
     * <P>
     * If <CODE>score</CODE> is null or <CODE>times</CODE> is less than one then
     * this method does nothing.
     * 
     * @param score Score to be repeated
     * @param times integer representing the number of repeats
     ...
     * 
     * <P>
     * If <CODE>score1</CODE> or <CODE>score2</CODE> is null then this method
     * does nothing.
     * 
     ...
     * 
     * <P>
     * If <CODE>score</CODE> is null or <CODE>qValue</CODE> is less than or
     * equal to zero then this method does nothing.
     * 
     ...
     * 
     * <P>
     * If <CODE>score</CODE> is null or <CODE>meter</CODE> is less than or equal
     * to zero then this method does nothing.
     * 
    ...
    /**
     * Joins consecutive rests in each <CODE>phrase</CODE> creating one longer
     * note.
     * This is simmilar to the musical function of a tie.
     * This modification may reduce the overall rest count.
     * 
    ...
    /**
     * Lengthens notes followed by a rest in the <CODE>score</CODE> by creating
     * one longer note and deleting the rest.
     * This modification may reduce the overall note count in the phrase,
     * be careful that use of this method does not to cause
     * array out of bounds exceptions.
     ...
     * phrase.
     * <P>
     * If the <CODE>Score</CODE> is null then this method does nothing.
     * 
     * @param score The Score to be effected
     * @param minlength The shortest possible duration
     * @param maxlength The longest possible duration
    ...
    /**
     * Vary both the rhythm value and duration of each note in the Score by the
     * specified amount.
     * 
     * @param score - The Score to be modified.
     * @param amount - The number of beats to add.
