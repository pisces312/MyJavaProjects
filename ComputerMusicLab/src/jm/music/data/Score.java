 ...
 * data is algorithmically generated or read from a standard MIDI file, but can
 * also be read and saved to
...
public class Score implements JMC, Cloneable, Serializable {
     ...
     * 
     */
    private static final long  serialVersionUID      = 844082895896429909L;
    ...
    public Part [] getPartArray() {
        Vector<Part> vct = (Vector<Part>)partList.clone();
    ...
    public Part getPart(String title) {
        Enumeration<Part> enum1 = partList.elements();
     ...
     *         this convenience method which requires importing the java.awt
     *         package
    ...
    public Score copy() {
        ...
        Enumeration<Part> enum1 = this.partList.elements();
        while (enum1.hasMoreElements()) {
            Part oldPart = enum1.nextElement();
    ...
    public double getEndTime() {
        ...
        Enumeration<Part> enum1 = this.partList.elements();
        while (enum1.hasMoreElements()) {
            Part nextPart = enum1.nextElement();
    ...
    public void empty(boolean nullObjects) {
        if (nullObjects) {
            Enumeration<Part> enum1 = getPartList().elements();
            while (enum1.hasMoreElements()) {
                Part part = enum1.nextElement();
