...
public class Notate extends JFrame implements
        ActionListener,
        WindowListener, JMC {
    /**
     * 
     */
    private static final long  serialVersionUID = -6818697806286978248L;
    private Score              score;
    //private Stave stave;
    ...
    private MenuItem           keySig, open, openJmXml, openjm,
                               //    play, 
                               //    stop, 
            delete, clear,
    ...
    public void init() {
        ...
        */
        //TODO?? close one window will exit the whole app
    ...
    */
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == close)
            dispose();
        else if (e.getSource() == newStave)
            new Notate();
        else if (e.getSource() == open)
            openMidi();
        else if (e.getSource() == openjm)
            openJM();
        else if (e.getSource() == openJmXml)
            openJMXML();
        else if (e.getSource() == keySig) {
            for (int i = 0; i < staveArray.length; i++) {
        ...
        else if (e.getSource() == saveJM)
            saveJM();
        else if (e.getSource() == saveJmXml)
            saveJMXML();
        else if (e.getSource() == saveMidi)
            saveMidi();
        ...
        else if (e.getSource() == trebleStave) {
        ...
        else if (e.getSource() == pianoStave) {
            setCursor(new Cursor(Cursor.WAIT_CURSOR));
            makePianoStave();
            for (int i = 0; i < staveArray.length; i++) {
                staveArray[i].repaint();
        ...
        else if (e.getSource() == grandStave) {
            setCursor(new Cursor(Cursor.WAIT_CURSOR));
            makeGrandStave();
            for (int i = 0; i < staveArray.length; i++) {
                staveArray[i].repaint();
        ...
        else if (e.getSource() == automaticStave) {
            setCursor(new Cursor(Cursor.WAIT_CURSOR));
            makeAppropriateStaves();
            for (int i = 0; i < staveArray.length; i++) {
                staveArray[i].repaint();
    ...
    public void windowClosing(WindowEvent e) {
        if (e.getSource() == this)
            dispose();
        if (e.getSource() == keyDialog)
            keyDialog.dispose();
        if (e.getSource() == timeDialog)
            timeDialog.dispose();
    }
