...
package com.ibm.nili.presentation; /* Put resulting class into tutorial package. */

import java.applet.Applet;
import java.awt.GridLayout;

import com.ibm.nili.test.jsyn.Siren;
...
public class SirenTest extends Applet
{
    /**
     * 
     */
    private static final long serialVersionUID = -7760054481806407692L;
    ...
    public static void main(String args[])
    {
        ...
        SirenTest applet = new SirenTest();
