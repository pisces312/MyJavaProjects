...
/**
 * This class does statistical analysis on MIDI files
 * It prompts the user to select a file
 * this proceedure repeats until the user selects 'cancel'
 * 
 * @author Andrew Brown
 */

public final class MIDIFileAnalysis extends JFrame implements JMC {
    /**
     * 
     */
    private static final long   serialVersionUID = -1693629863246077969L;
    ...
    public static void main(String [] args) {
        new MIDIFileAnalysis();
    }

    public MIDIFileAnalysis() {
        FileDialog fd;
        //        Frame f = new Frame();
        ...
        for (;;) {
            ...
            Enumeration<Part> enum1 = s.getPartList().elements();
            while (enum1.hasMoreElements()) {
                Part nextPt = enum1.nextElement();
                Enumeration enum2 =
