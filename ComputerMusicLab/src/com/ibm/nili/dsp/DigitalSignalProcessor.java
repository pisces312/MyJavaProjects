...
public interface DigitalSignalProcessor {
     ...
     * @param pFrameRateRatioHint A float value representing the ratio of the
     *            current
     ...
     */
    void process(float [] pLeftChannel, float [] pRightChannel, float timeStamp, float pFrameRateRatioHint);
    void afterAllProccesed();
